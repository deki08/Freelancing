                                                ...
                                                <div className="card-body">
                                                    <ul className="nav nav-tabs">
                                                        <li className="nav-item">
                                                            <a className="nav-link" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="false">Biometric Data</a>
                                                        </li>
                                                        <li className="nav-item">
                                                            <a className="nav-link active" id="base-tab2" data-toggle="tab" aria-controls="tab2" href="#tab2" aria-expanded="true">Medical Report</a>
                                                        </li>
                                                        <li className="nav-item">
