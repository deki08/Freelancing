...
export const MENU = [
    {
        ...
        submenu: [
            ...
            { id: 4, label: "Actual Bill", path: "/bills/actual", page: "ACTUAL_BILL", permission: 'edit' },
        ]
    }, {
        ...
        submenu: [
            ...
            { id: 6, label: "Reported Settings", path: "/settings/reported/update", page: "REF_VAL", permission: 'list' },
        ]
    },
];
