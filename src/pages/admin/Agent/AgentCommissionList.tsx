...
function AgentCommissionList(props: any) {
    const navigate = useNavigate();
    const permission = AuthService.getPermission('AGENT_COMMISSION');
    ...
    const columns: {}[] = [
        ...
        {data: "status",name: "Status", render: statusRender, class: "text-center width-150",sort:true},
    ];
                ...
                <div className="content-wrapper">
                    ...
                    <div className="content-header row">
                        <div className="content-header-left col-md-4 col-12 mb-2">
                            <h3 className="content-header-title">Agent Commission List</h3>
                        </div>
                            ...
                            <div className="breadcrumbs-top float-md-right">
                                <div className="breadcrumb-wrapper mr-1">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><a href="/agent">Agent</a>
                                        </li>
                                ...
                                <div className="card">
                                    <div className="card-content collapse show">
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                                <div className="col-12">
                                                    {permission.pay?<div className={'input-group  pull-right width-500'}>
                                            ...
                                            <DataTable columns={columns} data={data} onSearch={handleSearch}
                                                       endpoint={API_ROUTES.COMMISSION_AGENT_ADVANCE_SEARCH}
                                                       refresh={refresh}
                                                       dateFilter={true} actionButtons={true}
                                                       searchPlaceholder={"Agency Name, Mobile, Email, Status"}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
