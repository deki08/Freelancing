        ...
        <section className="card">
            ...
            <div id="invoice-template" className="card-body invoice-template">
                <div className="row">
                    <div className="col-3 text-center">
                        <ul className="px-0 list-unstyled">
                            ...
                            <li><span>REG DATE <br/>{moment(FuncUtil.toDateTime(patient.createdDate)).format('DD-MM-YYYY hh:mm A')}</span></li>
                        </ul>
                    </div>
                ...
                <table className={'w-100 font-weight-bolder invoice'} style={{width:'100%'}}>
                    ...
                    <tr><td>DATE OF BIRTH</td><td>{patient.dateOfBirth?moment(FuncUtil.toDate(patient.dateOfBirth)).format('DD-MM-YYYY'):''}</td><td>TRAVELLING TO</td><td>{patient.travelingTo}</td></tr>
                ...
                <div className="row">
                    <div className="col-3 text-center">
                        ...
                        <li><span>PATIENT ID : {bill.regNo}</span></li>
                            <li><Barcode value={patient.regNo} marginTop={5} displayValue={false} width={2} height={50}/></li>
                            <li><span>REG DATE <br/>{moment(FuncUtil.toDateTime(patient.createdDate)).format('DD-MM-YYYY hh:mm')}</span></li>
                        </ul>
                    </div>
                    <div className="col-2 text-center">
                        <ul className="px-0 list-unstyled">
