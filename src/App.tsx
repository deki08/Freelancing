    ...
    return (
        <Routes key={'r-1'}>
            ...
            <Route key={'private-routs'} element={<AdminLayout />}>
                ...
                <Route key={'pt-r-37'} path={'/profile'} element={<UserProfile />} />
                <Route key={'pt-r-38'} path={'/cashier-report'} element={<CashierReport />} />
                <Route key={'pt-r-39'} path={'/account-transfer'} element={<AccountTransferList />} />
                <Route key={'pt-r-40'} path={'/suppliers'} element={<SupplierList />} />
                <Route key={'pt-r-41'} path={'/bills/update'} element={<EditableBillsList />} />
                <Route key={'pt-r-42'} path={'/lab-reports'} element={<LabReports />} />
            </Route>
