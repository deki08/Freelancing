...
public class SecurityConfiguration {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				...
				.antMatchers("/actuator/**", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**",
						"/actuator/shutdown")
				.permitAll()
				.antMatchers("/api/v1/patient/**/passport", "/api/v1/patient/*", "/api/v1/ref-value", "/api/v1/sms/**")
				.permitAll()
				...
				.addFilterBefore(new JWTAuthFilter(jwtTokenService, userDetailsService()),
	 ...
	 * web.ignoring().antMatchers("/error", "/resources/**", "/static/**",
	 * "/assets/**", "/js/**", "/images/**", "/gallery/**"); }
	 */
